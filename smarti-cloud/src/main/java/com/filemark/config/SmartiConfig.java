...
public class SmartiConfig {
    ...
    private static String custom_config = "/smarti-custom.properties";
    private static String custom_jvm_param = "roller.custom.config";
    private static File custom_config_file = null;
 
    private static Properties config;
 
    private static Log log = LogFactory.getLog(SmartiConfig.class);
    ...
    static {
        ...
        try {
            ...
            Class config_class = Class.forName("com.filemark.config.SmartiConfig");
...
/*            // Now expand system properties for properties in the config.expandedProperties list,
  ...
  */         
    ...
    public static boolean getBooleanProperty(String name, boolean defaultValue) {
        ...
        String value = SmartiConfig.getProperty(name);
