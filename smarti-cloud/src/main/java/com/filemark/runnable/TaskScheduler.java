...
public class TaskScheduler implements Runnable {
    ...
    private final List<SmartiTask> tasks;
    
    @Autowired
    private ThreadManager threadManager;
    
    public TaskScheduler(List<SmartiTask> webloggerTasks) {
    ...
    private void runTasks(Date currentTime) {
        ...
        for( SmartiTask task : tasks ) {
            try {
                // get tasklock for the task
                TaskLock tasklock = threadManager.getTaskLockByName(task.getName());
