 ...
 */
public class AddWebPageOperation extends WriteToIndexOperation {
    
    //~ Static fields/initializers =============================================
	
    private static Log mLogger =
            LogFactory.getFactory().getInstance(AddWebPageOperation.class);
     ...
     */
    public AddWebPageOperation(IndexManagerImpl mgr,Page data) {
        super(mgr);
    ...
    public void doRun() {
        ...
        try {
            if (writer != null) {
                writer.addDocument(getWebDocument(data));
            }
        } catch (IOException e) {
