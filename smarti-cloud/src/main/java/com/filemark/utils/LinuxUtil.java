...
public class LinuxUtil
{
    ...
    public static String search(String username, String path, String query, long from, long size) throws IOException, InterruptedException {
    	String json = "{\"sort\" : [ {\"lastModified\" : {\"order\" : \"desc\" } } ], \"from\" : "+from+ ", \"size\" : "+size+",\"query\" : {\"bool\": {\"must\":  { \"query_string\": {\"query\" : \""+query+"\"} } , \"filter\" : [{\"term\": {\"createdBy\" : \""+username+"\" }  }, {\"term\" : {\"ocm_classname\":\"asset\"}}] } } }";
