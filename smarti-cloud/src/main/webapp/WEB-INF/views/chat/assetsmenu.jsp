...
<li><a href='<c:url value="/protected/chat.html"></c:url>'><span class="glyphicon glyphicon-envelope"></span> <spring:message code="djn.chat"></spring:message><span class="badge"></span></a></li>
...
<object type="image/svg+xml" tabindex="-1" data="<c:url value="/assets/templates/images/djnlogo.svg" />"></object>
</a>
</div>
