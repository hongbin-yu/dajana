		...
		<header class="panel-heading">群里用户</header>
			<div id="inGroup" class="panel panel-body">
				<c:forEach items="${usersInGroup.items }" var="item" varStatus="loop">
					...
					<p><a class="wb-lbx" href="${url }/forget?j=${user.encodedJson}" title="密码图"><img class="img-responsive" src="/content/password.qrb?path=${url }/forget?j=${user.encodedJson}" alt="密码图"><span class="glyphicon glyphicon-qrcode"></span></a>
