	...
	<form  method="POST" id="page-modify" accept-charset="UTF-8">
		...
		<div class="panel panel-body">
			<c:forEach items="${users.items }" var="item" varStatus="loop">
				...
				<a class="wb-lbx" href="/content/password.qrb.jpg?path=${url }/forget?j=${item.encodedJson}&r=/protected/youchat" title="密码图"><span class="glyphicon glyphicon-qrcode"></span></a>
				</c:if>
