...
<li><a href="javascript:openPdf()" class="btn btn-primary btn-xs visible-md visible-lg"><span class="glyphicon glyphicon-open"></span>PDF</a></li>
<li><a href="javascript:deleteFiles()" class="btn btn-danger btn-xs visible-md visible-lg"><span class="glyphicon glyphicon-remove"></span><spring:message code="djn.delete"></spring:message></a></li>
