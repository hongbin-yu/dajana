...
<nav role="navigation" id="wb-sm" data-trgt="mb-pnl" class="wb-menu visible-md visible-lg">
	...
	<div class="row">
		<ul class="list-inline menu" role="menubar">
			<li id="goto_cloud_edit"><a class="item" title="<spring:message code="djn.goto_cloud"></spring:message>" href="<c:url value="/site/assets.html"/>?path=${folder.path}&type=${type}"><span class="glyphicon glyphicon-edit"></span><spring:message code="djn.cloud"></spring:message><spring:message code="djn.edit"></spring:message></a></li>
