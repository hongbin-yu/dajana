...
<section class="modal-dialog modal-content overlay-def">
	<header class="modal-header">
		<H1 class="modal-title">删除页面/资源</H1>
	</header>
	...
	<form  method="POST" action="javascript:deleteNode('${smartiNode.path }','${smartiNode.uid}')" id="deleteNode" accept-charset="UTF-8">
		...
		<button type="button" onclick="javascript:deleteNode('${smartiNode.path }','${smartiNode.uid}')" class="btn btn-primary popup-modal-dismiss">删除</button>  <button class="btn btn-primary popup-modal-dismiss" type="button">关闭</button>
	</form>
	</div>
</section>
