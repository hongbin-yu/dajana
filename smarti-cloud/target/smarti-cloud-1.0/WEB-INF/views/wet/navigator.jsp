...
<li><a class="wb-lbx lbx-modal" href="profile.html"><authz:authentication property="name" /></a></li>
</ul>
</section>
</c:if>
...
<a href="<c:url value="/content/home.html"/>">
...
<button type="submit" id="wb-srch-sub" class="btn btn-default">天问</button>
</form>
