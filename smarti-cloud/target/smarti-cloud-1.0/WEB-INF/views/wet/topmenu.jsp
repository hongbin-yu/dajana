...
<li><a href="<c:url value="/site/editor.html?path=${page.path }"/>"><img title="<spring:message code="djn.edit_this_page"/>" alt="" src='<c:url value="/resources/images/unlock.png"></c:url>'><spring:message code="djn.edit"/></a></li>
<li><a href="<c:url value="/signup"/>"><img title="<spring:message code="djn.register"/>" alt="" src='<c:url value="/resources/images/tool_app.gif"></c:url>'><spring:message code="djn.register"/></a></li>
<li><a href="<c:url value="/logout"/>"><img title="<spring:message code="djn.logout"/>" alt="" src='<c:url value="/resources/images/lock.gif"></c:url>'><spring:message code="djn.logout"/></a></li>
</authz:authorize>
</ul>
</div>
